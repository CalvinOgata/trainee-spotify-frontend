      ...
      <ul ref={scrollRef} className="scroll-auto-hide flex min-h-0 flex-1 flex-col overflow-y-auto px-2">
        {rows.map((row) => {
          ...
          if (row.kind === 'artist') {
            return (
              <li key={row.key}>
                <button onClick={() => onArtistClick(row.artist)} className={buttonClass}>
                  {content}
                </button>
              </li>
            )
          ...
          if (row.kind === 'playlist') {
            return (
              <li key={row.key}>
                <button onClick={() => onPlaylistClick(row.playlist)} className={buttonClass}>
                  {content}
                </button>
              </li>
            )
          ...
          return (
            <li key={row.key}>
              <button onClick={() => onAlbumClick(row.album)} className={buttonClass}>
                {content}
              </button>
            </li>
          )
